...
class Tag(db.Model):
    ...
    articles = db.relationship("ArticleTag", secondary=article_tag)
...
class User(db.Model):
    ...
    rated_comments = db.relationship("RatedComment", secondary=rated_comment)
...
class Article(db.Model):
    ...
    tags = db.relationship("ArticleTag", secondary=article_tag)
...
class Comment(db.Model):
    ...
    users_rated = db.relationship("RatedComment", secondary=rated_comment)
